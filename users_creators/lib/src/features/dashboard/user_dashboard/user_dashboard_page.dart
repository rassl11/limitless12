...
class _UserDashboardState extends State<UserDashboard> {
  ...
  @override
  void initState() {
    context.read<GetSessionRangeBloc>().add(GotSessionRangeEvent(
        requestDate: 'Last 10 days', requestRange: lastTenSession));
    super.initState();
  }
              ...
              return Column(children: [
                ...
                Expanded(
                  child: RefreshIndicator(
                      ...
                      onRefresh: () async {
                        context.read<GetSessionRangeBloc>().add(
                            GotSessionRangeEvent(
                                requestRange:
                                    GetSessionRangeEvent.lastRequestRange));
                      },
