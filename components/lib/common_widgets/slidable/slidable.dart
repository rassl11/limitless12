import 'package:components/common_widgets/slidable/action_pane_configuration.dart';
import 'package:components/common_widgets/slidable/auto_close_behavior.dart';
import 'package:components/common_widgets/slidable/controller.dart';
import 'package:components/common_widgets/slidable/dismissal.dart';
import 'package:components/common_widgets/slidable/gesture_detector.dart';
import 'package:components/common_widgets/slidable/notifications.dart';
import 'package:components/common_widgets/slidable/scrolling_behavior.dart';
...
class CustomSlidable extends StatefulWidget {
  ...
  final ActionPaneCustom? startActionPane;
  ...
  /// When [direction] is [Axis.horizontal] and [useTextDirection] is true, the
  /// [startActionPane] is determined by the ambient [TextDirection].
  final ActionPaneCustom? endActionPane;
...
class _CustomSlidableState extends State<CustomSlidable>
  ...
  ActionPaneCustom? get startActionPane => widget.startActionPane;
  ActionPaneCustom? get endActionPane => widget.endActionPane;
